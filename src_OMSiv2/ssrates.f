...
c      
     ...
     +))*sp(1,j)*(sw02+(0.1D1-sw02)*sp(2,j)/kmo2)+0.4056603774D0*(0.1D1-
     +por(j))/por(j)*nu/(inita+sp(32,j))*sp(1,j)*sw11*(0.1D1-sw02-(0.1D1
     +-sw02)*sp(2,j)/kmo2-sw03*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2)*(s
     +w04+(0.1D1-sw04)*sp(3,j)/kmno3)-sw05*(0.1D1-sw02-(0.1D1-sw02)*sp(2
     +,j)/kmo2-sw03*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2)*(sw04+(0.1D1-
     ...
     +no2))*(sw08+(0.1D1-sw08)*sp(5,j)/kmfeoh3)-sw09*(0.1D1-sw02-(0.1D1-
     +sw02)*sp(2,j)/kmo2-sw03*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2)*(sw
     +04+(0.1D1-sw04)*sp(3,j)/kmno3)-sw05*(0.1D1-sw02-(0.1D1-sw02)*sp(2,
     +j)/kmo2-sw03*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2)*(sw04+(0.1D1-s
     ...
     +j)/kmso4))-0.108D1*(0.1D1-por(j))/por(j)*sw26*kglass*sp(47,j)*(sp(
     +20,j)**3/sp(42,j))**(1.D0/3.D0)*(0.1D1-sp(40,j)*sp(42,j)**0.36D0/s
     +p(20,j)**0.108D1/kspglass)+kaomo2*sp(7,j)*sp(2,j)+0.2D1*kfesprecip
     +*sw13*(sp(11,j)*sp(13,j)/sp(20,j)/KsFeS-0.1D1)-kaom*sp(7,j)*sp(6,j
     +)+0.6D1*sw32*kkaoli*(sp(42,j)**2*sp(40,j)**2/sp(20,j)**6/kspkaoli-
     +0.1D1)-0.4D1*(0.1D1-por(j))/por(j)*(kh2sfeoh3*sp(5,j)*(sp(12,j)+sp
     +(13,j))+kh2sfeoh3mr*sp(34,j)*(sp(12,j)+sp(13,j))+kh2sfeoh3pr*sp(35
     +,j)*(sp(12,j)+sp(13,j)))+0.2D1*knit*sp(8,j)*sp(2,j)+0.2D1*kh2so2*(
     +sp(12,j)+sp(13,j))*sp(2,j)-kb1*sp(15,j)+0.6D1*sw31*ksmect*(sp(22,j
     +)**0.165D0*sp(38,j)**0.33D0*sp(42,j)**0.17D1*sp(40,j)**4/sp(20,j)*
     +*6/kspsmect-0.1D1)+kf1*sp(20,j)*sp(16,j)+0.8D1*sw30*killite*(sp(40
     +,j)**0.35D1*sp(42,j)**0.23D1*sp(50,j)**0.6D0*sp(38,j)**0.25D0/sp(2
     +0,j)**8/kspillite-0.1D1)+0.2D1*kfeo2*sp(11,j)*sp(2,j)+0.2D1*kdi*sw
     +19*sp(27,j)+0.2D1*kmnox*sp(10,j)*sp(2,j)-0.7094339623D1*(0.1D1-por
     +(j))/por(j)*nu/(inita+sp(32,j))*sp(1,j)*sw07*(0.1D1-sw02-(0.1D1-sw
     ...
     +4)*sp(3,j)/kmno3))*(sw06+(0.1D1-sw06)*sp(4,j)/kmmno2))*(sw08+(0.1D
     +1-sw08)*sp(5,j)/kmfeoh3)-0.4D1*(0.1D1-por(j))/por(j)*sw28*kolive*s
     +p(51,j)*(0.1D1-sp(40,j)*sp(38,j)**0.16D1*sp(11,j)**0.4D0/sp(20,j)*
     +*4/kspolive)-0.4D1*(0.1D1-por(j))/por(j)*sw29*kpyrox*sp(52,j)*(0.1
     +D1-sp(40,j)**2*sp(11,j)**0.46D0*sp(38,j)**0.84D0*sp(22,j)**0.7D0/s
     +p(20,j)**4/ksppyrox)-0.2D1*(0.1D1-por(j))/por(j)*kfesdiss*(0.1D1-s
     +w13)*sp(25,j)*(0.1D1-sp(11,j)*sp(13,j)/sp(20,j)/KsFeS)+0.2D1*(kfem
     +no2*sp(11,j)*sp(4,j)+kfemno2pr*sp(11,j)*sp(33,j))*(0.1D1-por(j))/p
     +or(j)-0.2D1*(kh2smno2*sp(4,j)*(sp(12,j)+sp(13,j))+kh2smno2pr*sp(33
     +,j)*(sp(12,j)+sp(13,j)))*(0.1D1-por(j))/por(j)+0.1509433962D0*(0.1
     +D1-por(j))/por(j)*nu/(inita+sp(32,j))*sp(1,j)*sw03*(0.1D1-sw02-(0.
     +1D1-sw02)*sp(2,j)/kmo2)*(sw04+(0.1D1-sw04)*sp(3,j)/kmno3)-0.943396
     +2264D-1*(0.1D1-por(j))/por(j)*nu/(inita+sp(32,j))*sp(1,j)*sw09*(0.
     +1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2-sw03*(0.1D1-sw02-(0.1D1-sw02)*s
     +p(2,j)/kmo2)*(sw04+(0.1D1-sw04)*sp(3,j)/kmno3)-sw05*(0.1D1-sw02-(0
     +.1D1-sw02)*sp(2,j)/kmo2-sw03*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2
     +)*(sw04+(0.1D1-sw04)*sp(3,j)/kmno3))*(sw06+(0.1D1-sw06)*sp(4,j)/km
     +mno2)-sw07*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2-sw03*(0.1D1-sw02-
     ...
     +06)*sp(4,j)/kmmno2))*(sw08+(0.1D1-sw08)*sp(5,j)/kmfeoh3))*(sw10+(0
     +.1D1-sw10)*sp(6,j)/kmso4)-0.3094339623D1*(0.1D1-por(j))/por(j)*nu/
     +(inita+sp(32,j))*sp(1,j)*sw05*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo
     +2-sw03*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2)*(sw04+(0.1D1-sw04)*s
     +p(3,j)/kmno3))*(sw06+(0.1D1-sw06)*sp(4,j)/kmmno2)
            drdc = -kb1
            endif
            if (isp.eq.16) then
            rat = -0.1320754717D0*(0.1D1-por(j))/por(j)*nu/(inita+sp(32,
     +j))*sp(1,j)*(sw02+(0.1D1-sw02)*sp(2,j)/kmo2)+0.9433962264D-1*(0.1D
     ...
     +6,j)/kmso4))+0.108D1*(0.1D1-por(j))/por(j)*sw26*kglass*sp(47,j)*(s
     +p(20,j)**3/sp(42,j))**(1.D0/3.D0)*(0.1D1-sp(40,j)*sp(42,j)**0.36D0
     +/sp(20,j)**0.108D1/kspglass)-0.2D1*kfesprecip*sw13*(sp(11,j)*sp(13
     +,j)/sp(20,j)/KsFeS-0.1D1)+0.2D1*kaom*sp(7,j)*sp(6,j)-0.6D1*sw32*kk
     +aoli*(sp(42,j)**2*sp(40,j)**2/sp(20,j)**6/kspkaoli-0.1D1)+0.4D1*(0
     +.1D1-por(j))/por(j)*(kh2sfeoh3*sp(5,j)*(sp(12,j)+sp(13,j))+kh2sfeo
     +h3mr*sp(34,j)*(sp(12,j)+sp(13,j))+kh2sfeoh3pr*sp(35,j)*(sp(12,j)+s
     +p(13,j)))-0.2D1*knit*sp(8,j)*sp(2,j)-0.2D1*kh2so2*(sp(12,j)+sp(13,
     +j))*sp(2,j)+kb1*sp(15,j)-kb2*sp(16,j)-0.6D1*sw31*ksmect*(sp(22,j)*
     +*0.165D0*sp(38,j)**0.33D0*sp(42,j)**0.17D1*sp(40,j)**4/sp(20,j)**6
     +/kspsmect-0.1D1)-kf1*sp(20,j)*sp(16,j)-0.8D1*sw30*killite*(sp(40,j
     +)**0.35D1*sp(42,j)**0.23D1*sp(50,j)**0.6D0*sp(38,j)**0.25D0/sp(20,
     +j)**8/kspillite-0.1D1)+kf2*sp(20,j)*sp(17,j)-0.2D1*kfeo2*sp(11,j)*
     +sp(2,j)-0.2D1*kdi*sw19*sp(27,j)-0.2D1*kmnox*sp(10,j)*sp(2,j)+0.809
     +4339623D1*(0.1D1-por(j))/por(j)*nu/(inita+sp(32,j))*sp(1,j)*sw07*(
     +0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2-sw03*(0.1D1-sw02-(0.1D1-sw02)
     +*sp(2,j)/kmo2)*(sw04+(0.1D1-sw04)*sp(3,j)/kmno3)-sw05*(0.1D1-sw02-
     +(0.1D1-sw02)*sp(2,j)/kmo2-sw03*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/km
     +o2)*(sw04+(0.1D1-sw04)*sp(3,j)/kmno3))*(sw06+(0.1D1-sw06)*sp(4,j)/
     +kmmno2))*(sw08+(0.1D1-sw08)*sp(5,j)/kmfeoh3)+0.4D1*(0.1D1-por(j))/
     +por(j)*sw28*kolive*sp(51,j)*(0.1D1-sp(40,j)*sp(38,j)**0.16D1*sp(11
     +,j)**0.4D0/sp(20,j)**4/kspolive)+0.4D1*(0.1D1-por(j))/por(j)*sw29*
     +kpyrox*sp(52,j)*(0.1D1-sp(40,j)**2*sp(11,j)**0.46D0*sp(38,j)**0.84
     +D0*sp(22,j)**0.7D0/sp(20,j)**4/ksppyrox)+0.2D1*(0.1D1-por(j))/por(
     +j)*kfesdiss*(0.1D1-sw13)*sp(25,j)*(0.1D1-sp(11,j)*sp(13,j)/sp(20,j
     +)/KsFeS)-0.2D1*(kfemno2*sp(11,j)*sp(4,j)+kfemno2pr*sp(11,j)*sp(33,
     +j))*(0.1D1-por(j))/por(j)+0.2D1*(kh2smno2*sp(4,j)*(sp(12,j)+sp(13,
     +j))+kh2smno2pr*sp(33,j)*(sp(12,j)+sp(13,j)))*(0.1D1-por(j))/por(j)
     ++0.8490566038D0*(0.1D1-por(j))/por(j)*nu/(inita+sp(32,j))*sp(1,j)*
     +sw03*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2)*(sw04+(0.1D1-sw04)*sp(
     +3,j)/kmno3)+0.1094339623D1*(0.1D1-por(j))/por(j)*nu/(inita+sp(32,j
     +))*sp(1,j)*sw09*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2-sw03*(0.1D1-
     +sw02-(0.1D1-sw02)*sp(2,j)/kmo2)*(sw04+(0.1D1-sw04)*sp(3,j)/kmno3)-
     ...
     +/kmfeoh3))*(sw10+(0.1D1-sw10)*sp(6,j)/kmso4)+0.4094339623D1*(0.1D1
     +-por(j))/por(j)*nu/(inita+sp(32,j))*sp(1,j)*sw05*(0.1D1-sw02-(0.1D
     +1-sw02)*sp(2,j)/kmo2-sw03*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2)*(
     ...
     +20,j)**2-0.16D2*kf13*sp(46,j)*sp(20,j)**3
            endif
            if (isp.eq.21) then
     ...
     +*sp(22,j)**0.7D0/sp(20,j)**4/ksppyrox)+0.7D0*(0.1D1-por(j))/por(j)
     +*sw27*kplagio*sp(48,j)*(sp(20,j)**3/sp(42,j))**0.35D0*(0.1D1-sp(40
     +,j)**0.23D1*sp(46,j)**0.17D1*sp(49,j)**0.3D0*sp(22,j)**0.7D0/ksppl
     ...
     +*0.46D0*sp(38,j)**0.84D0/sp(22,j)**0.3D0/sp(20,j)**4/ksppyrox-0.49
     +D0*(0.1D1-por(j))/por(j)*sw27*kplagio*sp(48,j)*(sp(20,j)**3/sp(42,
     +j))**0.35D0*sp(40,j)**0.23D1*sp(46,j)**0.17D1*sp(49,j)**0.3D0/sp(2
     +2,j)**0.3D0/kspplagio-0.27225D-1*sw31*ksmect/sp(22,j)**0.835D0*sp(
