...
c      
     ...
     +,j)
            ...
            r(51,j) = kf11*sp(44,j)*sp(20,j)-kb11*sp(43,j)
            r(52,j) = kf12*sp(45,j)*sp(20,j)-kb12*sp(44,j)
            r(53,j) = kf13*sp(46,j)*sp(20,j)-kb13*sp(45,j)
     ...
     +E0*(0.1E1-sp(40,j)**0.23E1*sp(42,j)**0.17E1*sp(49,j)**0.7E0*sp(22,
     +j)**0.3E0/kspplagio)
