...
c      
     ...
     +1,j)*sp(13,j)/sp(20,j)/KsFeS)+2*(-1+por(j))/por(j)/delt
         ...
         pd(43,4) = 0
         pd(48,42) = -0.2061729385D1*por(j)/(-1+por(j))*sw31*ksmect*sp(2
     +2,j)**0.165D0*sp(38,j)**0.33D0*sp(42,j)**0.7D0*sp(40,j)**4/sp(20,j
     +)**6/kspsmect+0.7029624D8/0.101207189D9*por(j)/(-1+por(j))/delt
         ...
         pd(30,12) = 0
         pd(31,40) = 0.69D0*sw27*kplagio*sp(48,j)*(sp(20,j)**3/sp(42,j))
     +**0.35D0*sp(40,j)**0.13D1*sp(42,j)**0.17D1*sp(49,j)**0.7D0*sp(22,j
     +)**0.3D0/kspplagio
         pd(33,20) = 0
         pd(36,4) = 0
         pd(39,31) = 0
     ...
     +eoh3)-por(j)/(-1+por(j))*kmnox*sp(10,j)-2*por(j)/(-1+por(j))/delt
         ...
         pd(41,38) = 0
         pd(43,37) = 0
         pd(46,45) = 84667.D0/244450.D0/delt
         pd(47,5) = 0
     ...
     +j)/sp(20,j)**2/KsFeS
         ...
         pd(35,45) = 0
         pd(40,27) = 0
         pd(48,36) = -148124220.D0/0.101207189D9/delt
         pd(51,34) = 0
     ...
     +S
         ...
         pd(42,1) = 0
         pd(43,31) = 0
         pd(46,39) = 0.33782133D8/0.9778D8*(-1+por(j))/por(j)/delt
         pd(7,53) = 0
         pd(8,19) = 0
         pd(12,53) = 0
         pd(13,12) = 3/delt
         ...
         pd(6,48) = 57897.D0/39112.D0*(-1+por(j))/por(j)/delt
         pd(9,32) = 0
         pd(10,18) = 0
         pd(14,18) = 0
         pd(19,38) = 0
         ...
         pd(48,53) = 0
         pd(55,1) = 0
         pd(2,26) = 811.D0/8268.D0*(-1+por(j))/por(j)/delt
     ...
     +6.D0*por(j)/(-1+por(j))/delt
         pd(43,9) = 0
         pd(46,16) = 0
         pd(48,47) = 0.224947968D9/0.506035945D9/delt
     ...
     +kmso4)+809.D0/156.D0/delt
         ...
         pd(40,28) = 0
         pd(40,55) = 0
         pd(48,37) = -148124220.D0/0.101207189D9/delt
         pd(51,35) = 0
     ...
     +j)/kmno3)
         ...
         pd(26,4) = kmnage+1/delt
         pd(27,34) = 0
         pd(32,49) = 0
         pd(34,7) = 0
         pd(53,13) = 0
         pd(6,47) = -4176.D0/122225.D0*(-1+por(j))/por(j)/delt
         pd(10,17) = -kmnco3precip*sw12*sp(10,j)/KsMnCO3
         pd(14,17) = 0
         pd(19,37) = 0
         pd(23,24) = 0
         pd(24,37) = 0
         ...
         pd(42,55) = 0
         pd(45,51) = 0
         pd(46,11) = -0.1180206667D1*(-1+por(j))/por(j)*sw29*kpyrox*sp(5
     +2,j)*sp(40,j)**2/sp(11,j)**0.54D0*sp(38,j)**0.84D0*sp(22,j)**0.7D0
     +/sp(20,j)**4/ksppyrox
         pd(8,25) = 0
         pd(13,18) = 0
         pd(16,12) = 0
         ...
         pd(23,14) = 0
         pd(24,27) = 0
         pd(26,33) = -kfemno2pr*sp(11,j)-kh2smno2pr*(sp(12,j)+sp(13,j))
         pd(30,30) = -1/delt
         pd(36,45) = 0
         pd(38,6) = 0
         pd(42,47) = 0
     ...
     +feoh3)
         ...
         pd(39,37) = 0
         pd(44,30) = 0
         pd(49,48) = -7.D0/10.D0*(-1+por(j))/por(j)
         pd(52,35) = 0
         pd(55,52) = 0
     ...
     +(5,j)/kmfeoh3)+809.D0/78.D0*por(j)/(-1+por(j))/delt
         ...
         pd(41,39) = 0
         pd(43,38) = 0
         pd(46,46) = 84667.D0/244450.D0/delt
         pd(47,6) = 0
     ...
     +*sp(6,j)/kmso4)/2
         ...
         pd(40,8) = 0
         pd(43,13) = 0
         pd(46,21) = -515699.D0/117336.D0*(-1+por(j))/por(j)/delt
         ...
         pd(37,30) = 0
         pd(43,30) = 0
         pd(46,38) = -0.215516D1*(-1+por(j))/por(j)*sw29*kpyrox*sp(52,j)
     +*sp(40,j)**2*sp(11,j)**0.46D0/sp(38,j)**0.16D0*sp(22,j)**0.7D0/sp(
     +20,j)**4/ksppyrox+84667.D0/391120.D0/delt
         pd(16,34) = 0
         pd(16,54) = 0
         pd(17,48) = 0.1022847D7/39112.D0*(-1+por(j))/por(j)/delt
         pd(19,19) = 1
     ...
     +/4889.D0/delt
         ...
         pd(7,21) = 0
         pd(12,19) = 0
         pd(17,26) = -(-1+por(j))/por(j)/delt/12
         pd(28,53) = 0
         pd(29,6) = 0
         pd(41,45) = 0
         pd(43,44) = -eq3_al
         pd(46,52) = 7697.D0/3000.D0*(-1+por(j))/por(j)*sw29*kpyrox*(0.1
     ...
     +sp(20,j)**6/kspkaoli+38596.D0/41843.D0/delt
         ...
         pd(51,10) = 0
         pd(54,14) = 0
         pd(2,31) = 811.D0/8268.D0*(-1+por(j))/por(j)/delt
         pd(4,34) = 0
         pd(11,48) = 0
         pd(12,41) = 0
         pd(18,13) = 0
         ...
         pd(29,32) = 0
         pd(47,38) = 0.4202327206D0*por(j)/(-1+por(j))*sw30*killite*sp(4
     ...
     +20,j)**8/kspillite
         ...
         pd(12,24) = 0
         pd(15,40) = 0
         pd(17,31) = -(-1+por(j))/por(j)/delt/12
         pd(20,18) = 0
     ...
     +/delt
         ...
         pd(25,9) = 0
         pd(25,52) = 0
         pd(27,26) = -692.D0/159.D0*(-1+por(j))/por(j)/delt
         pd(31,25) = 0
         pd(33,5) = 0
         pd(33,49) = 0
         pd(39,16) = 0
         ...
         pd(30,37) = 1/delt/106
         pd(38,13) = 0
         pd(45,48) = 57897.D0/9778.D0*(-1+por(j))/por(j)/delt
         pd(46,8) = 0
     ...
     +08+(0.1D1-sw08)*sp(5,j)/kmfeoh3)-kfemno2*sp(11,j)-kmnage-1/delt
         ...
         pd(12,15) = 0
         pd(20,9) = 0
         pd(28,48) = 57897.D0/39112.D0/delt
         pd(29,1) = 0
         pd(31,20) = -0.315D0*sw27*kplagio*sp(48,j)/(sp(20,j)**3/sp(42,j
     +))**0.65D0*(0.1D1-sp(40,j)**0.23D1*sp(42,j)**0.17D1*sp(49,j)**0.7D
     +0*sp(22,j)**0.3D0/kspplagio)*sp(20,j)**2/sp(42,j)
         pd(41,40) = -sw26*kglass*sp(47,j)*(sp(20,j)**3/sp(42,j))**(1.D0
     +/3.D0)*sp(42,j)**0.36D0/sp(20,j)**0.108D1/kspglass
         pd(43,39) = 0
         pd(46,47) = 677336.D0/0.3055625D7*(-1+por(j))/por(j)/delt
         pd(47,7) = 0
         pd(7,45) = 0
         pd(8,11) = 0
         pd(10,37) = 0
     ...
     +/kmso4)
         ...
         pd(37,29) = 0
         pd(43,29) = 0
         pd(46,37) = -515699.D0/117336.D0*(-1+por(j))/por(j)/delt
         pd(7,35) = 0
         pd(18,3) = 0
         pd(32,15) = 0
         pd(35,17) = 0
         ...
         pd(40,32) = 0
         pd(43,14) = 0
         pd(46,22) = -0.1795966667D1*(-1+por(j))/por(j)*sw29*kpyrox*sp(5
     +2,j)*sp(40,j)**2*sp(11,j)**0.46D0*sp(38,j)**0.84D0/sp(22,j)**0.3D0
     +/sp(20,j)**4/ksppyrox+515699.D0/117336.D0/delt
         pd(51,51) = 1
         pd(54,55) = 0
         pd(7,40) = 0
         pd(14,33) = 0
         ...
         pd(37,4) = 0
         pd(43,5) = 0
         pd(48,43) = 0.7029624D8/0.101207189D9*por(j)/(-1+por(j))/delt
         ...
         pd(43,10) = 0
         pd(46,17) = 0
         pd(48,48) = -2259522.D0/0.101207189D9/delt
     ...
     +1-sw04)*sp(3,j)/kmno3)
         ...
         pd(35,47) = 0
         pd(40,1) = 0
         pd(48,38) = -0.4002180571D0*por(j)/(-1+por(j))*sw31*ksmect*sp(2
     +2,j)**0.165D0/sp(38,j)**0.67D0*sp(42,j)**0.17D1*sp(40,j)**4/sp(20,
     +j)**6/kspsmect+0.4393515D8/0.101207189D9*por(j)/(-1+por(j))/delt
         ...
         pd(13,44) = 0
         pd(26,20) = 0
         pd(27,48) = -154392.D0/4889.D0*(-1+por(j))/por(j)/delt
         pd(34,23) = 0
         pd(40,23) = 0
         pd(40,44) = 0
         pd(50,11) = 0
     ...
     +(13,j)/sp(20,j)**2/KsFeS
         ...
         pd(42,10) = 0
         pd(43,40) = 0
         pd(46,48) = -10860467.D0/0.9778D7*(-1+por(j))/por(j)/delt
         pd(53,5) = 0
         pd(12,50) = 0
         pd(14,9) = 0
         pd(16,3) = 0
     ...
     +feoh3))*(0.1D1-sw10)/kmso4/2-2/delt
         ...
         pd(40,22) = 0
         pd(48,22) = -0.2001090285D0*por(j)/(-1+por(j))*sw31*ksmect/sp(2
     +2,j)**0.835D0*sp(38,j)**0.33D0*sp(42,j)**0.17D1*sp(40,j)**4/sp(20,
     +j)**6/kspsmect+0.14812422D9/0.101207189D9*por(j)/(-1+por(j))/delt
         pd(51,20) = 0
         pd(54,24) = 0
         pd(3,33) = 0
         pd(10,15) = 0
         ...
         pd(25,4) = 0
         pd(38,48) = -43704.D0/122225.D0*(-1+por(j))/por(j)/delt
         pd(39,11) = 0
         pd(44,5) = 0
         pd(48,28) = 0
         pd(51,26) = 0
         ...
         pd(39,28) = 0
         pd(44,21) = 0
         pd(48,45) = 0.7029624D8/0.101207189D9*por(j)/(-1+por(j))/delt
     ...
     +(17,j)/kspara)-(-1+por(j))/por(j)/delt
         ...
         pd(42,32) = 0
         pd(45,26) = -151.D0/689.D0*(-1+por(j))/por(j)/delt
         pd(49,45) = 0
         pd(55,49) = 0
         pd(5,35) = 0
         ...
         pd(41,35) = 0
         pd(43,34) = 0
         pd(46,42) = 84667.D0/244450.D0/delt
         pd(47,2) = 0
         pd(7,44) = 0
         pd(8,10) = 0
         pd(11,51) = 0
         ...
         pd(4,5) = kh2sfeoh3*(sp(12,j)+sp(13,j))+2*nu/(inita+sp(32,j))*s
     ...
     +1-sw02)*sp(2,j)/kmo2-sw03*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2)*(
     +sw04+(0.1D1-sw04)*sp(3,j)/kmno3))*(sw06+(0.1D1-sw06)*sp(4,j)/kmmno
     +2))*(0.1D1-sw08)/kmfeoh3*(sw10+(0.1D1-sw10)*sp(6,j)/kmso4))-2*nu/(
     +inita+sp(32,j))*sp(1,j)*sw09*sw07*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)
     +/kmo2-sw03*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2)*(sw04+(0.1D1-sw0
     +4)*sp(3,j)/kmno3)-sw05*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2-sw03*
     +(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2)*(sw04+(0.1D1-sw04)*sp(3,j)/
     +kmno3))*(sw06+(0.1D1-sw06)*sp(4,j)/kmmno2))*(0.1D1-sw08)/kmfeoh3*(
     +sw10+(0.1D1-sw10)*sp(6,j)/kmso4)+2*nu/(inita+sp(32,j))*sp(1,j)*sw0
     +7*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2-sw03*(0.1D1-sw02-(0.1D1-sw
     +02)*sp(2,j)/kmo2)*(sw04+(0.1D1-sw04)*sp(3,j)/kmno3)-sw05*(0.1D1-sw
     +02-(0.1D1-sw02)*sp(2,j)/kmo2-sw03*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)
     +/kmo2)*(sw04+(0.1D1-sw04)*sp(3,j)/kmno3))*(sw06+(0.1D1-sw06)*sp(4,
     +j)/kmmno2))*(0.1D1-sw08)/kmfeoh3+kfeage/2+1/delt/2
         pd(5,14) = 0
         pd(6,34) = 0
         pd(9,19) = 0
         pd(12,16) = 0
     ...
     +/por(j)*kh2sfeoh3*sp(5,j)/8+(-1+por(j))/por(j)*kh2smno2*sp(4,j)/8
         ...
         pd(36,42) = 0
         pd(47,42) = 0.3866141029D1*por(j)/(-1+por(j))*sw30*killite*sp(4
     ...
     +20,j)**8/kspillite
         ...
         pd(4,48) = 0.1254435D7/19556.D0/delt
         pd(8,26) = 0
         pd(18,28) = 0
         pd(20,53) = 0
         pd(25,47) = 0
     ...
     +)*(0.1D1-sw06)/kmmno2*(sw08+(0.1D1-sw08)*sp(5,j)/kmfeoh3)
         ...
         pd(12,39) = 0
         pd(22,13) = 0
         pd(31,48) = -3.D0/10.D0*sw27*kplagio*(sp(20,j)**3/sp(42,j))**0.
     +35D0*(0.1D1-sp(40,j)**0.23D1*sp(42,j)**0.17D1*sp(49,j)**0.7D0*sp(2
     +2,j)**0.3D0/kspplagio)-3.D0/10.D0/delt
         pd(32,18) = 0
         pd(33,28) = 0
         pd(36,12) = 0
         pd(36,34) = 0
     ...
     +1D1-sp(40,j)*sp(42,j)**0.36D0/sp(20,j)**0.108D1/kspglass)+1/delt
         ...
         pd(42,5) = 0
         pd(43,35) = 0
         pd(46,43) = 84667.D0/244450.D0/delt
         pd(1,15) = 0
     ...
     +2))*(0.1D1-sw08)/kmfeoh3
         ...
         pd(55,27) = 0
         pd(3,28) = 0
         pd(10,10) = -kmnco3precip*sw12*sp(17,j)/KsMnCO3
         pd(13,55) = 0
         pd(21,32) = 0
         pd(28,5) = 0
         pd(34,34) = -1/delt
         ...
         pd(30,20) = 0
         pd(42,37) = 0
         pd(45,31) = -151.D0/689.D0*(-1+por(j))/por(j)/delt
         pd(49,50) = 0
         pd(55,54) = 0
     ...
     +**0.35D0*sp(40,j)**0.23D1*sp(42,j)**0.17D1/sp(49,j)**0.3D0*sp(22,j
     +)**0.3D0/kspplagio
         pd(32,19) = 0
         pd(33,29) = 0
         pd(36,13) = 0
     ...
     +))*sp(39,j)/BSisat
         ...
         pd(21,47) = 0
         pd(24,45) = 0
         pd(27,31) = -160.D0/53.D0*(-1+por(j))/por(j)/delt
         pd(30,48) = 0
         pd(38,24) = 0
         pd(43,11) = 0
         pd(48,4) = 0
     ...
     +)**2/sp(20,j)**7/kspkaoli
         ...
         pd(39,22) = 0
         pd(44,15) = 0
         pd(48,39) = 0.350602497D9/0.506035945D9/delt
     ...
     +,j)/sp(20,j)**2/KsFeS
         ...
         pd(39,27) = 0
         pd(44,20) = sp(46,j)
         pd(48,44) = 0.7029624D8/0.101207189D9*por(j)/(-1+por(j))/delt
     ...
     +lt
         ...
         pd(41,29) = 0
         pd(43,28) = 0
         pd(46,36) = -515699.D0/117336.D0*(-1+por(j))/por(j)/delt
         pd(9,55) = 0
         pd(10,45) = 0
         pd(12,9) = 0
         pd(15,26) = 0
         ...
         pd(41,34) = 0
         pd(43,33) = 0
         pd(46,41) = 84667.D0/244450.D0*(-1+por(j))/por(j)/delt
         pd(47,1) = 0
         pd(1,55) = 0
         pd(5,36) = 0
     ...
     ++(0.1D1-sw08)*sp(5,j)/kmfeoh3))*(0.1D1-sw10)/kmso4
         ...
         pd(31,22) = 0.9D-1*sw27*kplagio*sp(48,j)*(sp(20,j)**3/sp(42,j))
     +**0.35D0*sp(40,j)**0.23D1*sp(42,j)**0.17D1*sp(49,j)**0.7D0/sp(22,j
     +)**0.7D0/kspplagio
     ...
     +o4)/2
         ...
         pd(48,21) = -148124220.D0/0.101207189D9/delt
         pd(51,19) = 0
         pd(54,23) = 0
         pd(3,20) = 0
         pd(7,10) = 0
         ...
         pd(42,6) = 0
         pd(43,36) = 0
         pd(46,44) = 84667.D0/244450.D0/delt
         pd(53,1) = 0
         pd(6,2) = -1/delt/4
         pd(10,53) = 0
         pd(13,21) = 0
         ...
         pd(43,21) = 0
         pd(46,29) = 0
         pd(50,48) = -169286.D0/209215.D0*(-1+por(j))/por(j)/delt
         pd(7,43) = 0
         pd(8,9) = 0
         pd(11,50) = 0
         pd(12,43) = 0
         ...
         pd(39,24) = 0
         pd(44,17) = 0
         pd(48,41) = 0.7029624D8/0.101207189D9/delt
         ...
         pd(39,29) = 0
         pd(44,22) = 0
         pd(48,46) = 0.7029624D8/0.101207189D9*por(j)/(-1+por(j))/delt
         pd(51,44) = -231.D0/4889.D0*por(j)/(-1+por(j))
         pd(52,27) = 0
         pd(54,48) = -90.D0/4889.D0
         pd(1,14) = 0
         pd(2,33) = 0
         pd(13,52) = 0
         pd(18,15) = 0
     ...
     +.D0/delt
         pd(48,20) = 753174.D0/103505.D0*por(j)/(-1+por(j))*sw31*ksmect*
     ...
     +*sp(40,j)*sp(38,j)**0.16D1*sp(11,j)**0.4D0/sp(20,j)**5/kspolive
         ...
         pd(37,42) = 0
         pd(43,42) = 0
         pd(46,50) = 0.14139389D8/0.234672D8/delt
         pd(53,7) = 0
         pd(1,41) = 0
         pd(12,52) = 0
         pd(14,11) = 0
         ...
         pd(41,33) = 0
         pd(43,32) = 0
         pd(46,40) = -7697.D0/1500.D0*(-1+por(j))/por(j)*sw29*kpyrox*sp(
     +52,j)*sp(40,j)*sp(11,j)**0.46D0*sp(38,j)**0.84D0*sp(22,j)**0.7D0/s
     +p(20,j)**4/ksppyrox-84667.D0/244450.D0/delt
         pd(7,42) = 0
         pd(8,8) = ksnh4*por(j)
         pd(12,42) = 0
         pd(16,48) = 0
     ...
     +21*karadis*sp(36,j)*sp(22,j)/kspara
         ...
         pd(12,34) = 0
         pd(22,7) = 0
         pd(25,25) = -kfesdiss*(0.1D1-sw13)*(0.1D1-sp(11,j)*sp(13,j)/sp(
     +20,j)/KsFeS)-kfeso2*sp(2,j)-1/delt
         pd(31,42) = 0.105D0*sw27*kplagio*sp(48,j)/(sp(20,j)**3/sp(42,j)
     +)**0.65D0*(0.1D1-sp(40,j)**0.23D1*sp(42,j)**0.17D1*sp(49,j)**0.7D0
     +*sp(22,j)**0.3D0/kspplagio)*sp(20,j)**3/sp(42,j)**2+0.51D0*sw27*kp
     +lagio*sp(48,j)*(sp(20,j)**3/sp(42,j))**0.35D0*sp(40,j)**0.23D1*sp(
     +42,j)**0.7D0*sp(49,j)**0.7D0*sp(22,j)**0.3D0/kspplagio
         pd(32,12) = 0
         pd(33,22) = 0
         pd(36,6) = 0
         pd(37,11) = 0
         pd(39,33) = 0
         pd(44,26) = 0
         pd(48,50) = 0.244572335D9/0.202414378D9*por(j)/(-1+por(j))/delt
         pd(51,48) = -5463.D0/24445.D0
         pd(52,31) = 0
         pd(54,52) = 0
         pd(5,30) = 0
         ...
         pd(41,13) = 0
         pd(43,12) = 0
         pd(46,20) = 7697.D0/750.D0*(-1+por(j))/por(j)*sw29*kpyrox*sp(52
     ...
     +sp(20,j)**5/ksppyrox
         ...
         pd(39,23) = 0
         pd(44,16) = 0
         pd(48,40) = -502116.D0/103505.D0*por(j)/(-1+por(j))*sw31*ksmect
     +*sp(22,j)**0.165D0*sp(38,j)**0.33D0*sp(42,j)**0.17D1*sp(40,j)**3/s
     +p(20,j)**6/kspsmect-70296240.D0/0.101207189D9*por(j)/(-1+por(j))/d
     +elt
         ...
         pd(25,34) = 0
         pd(27,9) = 0
         pd(47,40) = 0.5883258088D1*por(j)/(-1+por(j))*sw30*killite*sp(4
     ...
     +20,j)**8/kspillite
         ...
         pd(47,20) = -103505.D0/7697.D0*por(j)/(-1+por(j))*sw30*killite*
     +sp(40,j)**0.35D1*sp(42,j)**0.23D1*sp(50,j)**0.6D0*sp(38,j)**0.25D0
     +/sp(20,j)**9/kspillite
         pd(1,9) = 0
         pd(1,36) = 0
     ...
     +(j)/(-1+por(j))/delt
         ...
         pd(6,26) = 113.D0/424.D0*(-1+por(j))/por(j)/delt
         pd(8,52) = 0
         pd(9,11) = 0
         pd(16,31) = 0
         pd(16,52) = 0
         ...
         pd(1,22) = 0
         pd(5,11) = 0
         pd(6,31) = 15.D0/106.D0*(-1+por(j))/por(j)/delt
         pd(9,16) = 0
         pd(14,1) = 0
         pd(19,21) = 0
         pd(21,24) = 0
     ...
     +8+(0.1D1-sw08)*sp(5,j)/kmfeoh3)
         pd(47,50) = 0.1008558529D1*por(j)/(-1+por(j))*sw30*killite*sp(4
     +0,j)**0.35D1*sp(42,j)**0.23D1/sp(50,j)**0.4D0*sp(38,j)**0.25D0/sp(
     +20,j)**8/kspillite+517525.D0/184728.D0*por(j)/(-1+por(j))/delt
         pd(49,19) = 0
         pd(55,23) = 0
         pd(2,48) = 0.1254435D7/39112.D0*(-1+por(j))/por(j)/delt
