...
c      
     ...
     +20,j)/KsFeS)-kfeso2*sp(2,j)-1/delt
         ...
         pd(43,35) = 0
         pd(55,7) = 0
         pd(4,2) = 2*nu/(inita+sp(32,j))*sp(1,j)*sw09*(-(0.1D1-sw02)/kmo
     ...
     +p(32,j))*sp(1,j)*sw07*(-(0.1D1-sw02)/kmo2+sw03*(0.1D1-sw02)/kmo2*(
     +sw04+(0.1D1-sw04)*sp(3,j)/kmno3)-sw05*(-(0.1D1-sw02)/kmo2+sw03*(0.
     +1D1-sw02)/kmo2*(sw04+(0.1D1-sw04)*sp(3,j)/kmno3))*(sw06+(0.1D1-sw0
     +6)*sp(4,j)/kmmno2))*(sw08+(0.1D1-sw08)*sp(5,j)/kmfeoh3)+2*nu/(init
     +a+sp(32,j))*sp(1,j)*sw11*(-(0.1D1-sw02)/kmo2+sw03*(0.1D1-sw02)/kmo
     +2*(sw04+(0.1D1-sw04)*sp(3,j)/kmno3)-sw05*(-(0.1D1-sw02)/kmo2+sw03*
     +(0.1D1-sw02)/kmo2*(sw04+(0.1D1-sw04)*sp(3,j)/kmno3))*(sw06+(0.1D1-
     +sw06)*sp(4,j)/kmmno2)-sw07*(-(0.1D1-sw02)/kmo2+sw03*(0.1D1-sw02)/k
     +mo2*(sw04+(0.1D1-sw04)*sp(3,j)/kmno3)-sw05*(-(0.1D1-sw02)/kmo2+sw0
     +3*(0.1D1-sw02)/kmo2*(sw04+(0.1D1-sw04)*sp(3,j)/kmno3))*(sw06+(0.1D
     +1-sw06)*sp(4,j)/kmmno2))*(sw08+(0.1D1-sw08)*sp(5,j)/kmfeoh3)-sw09*
     +(-(0.1D1-sw02)/kmo2+sw03*(0.1D1-sw02)/kmo2*(sw04+(0.1D1-sw04)*sp(3
     +,j)/kmno3)-sw05*(-(0.1D1-sw02)/kmo2+sw03*(0.1D1-sw02)/kmo2*(sw04+(
     +0.1D1-sw04)*sp(3,j)/kmno3))*(sw06+(0.1D1-sw06)*sp(4,j)/kmmno2)-sw0
     +7*(-(0.1D1-sw02)/kmo2+sw03*(0.1D1-sw02)/kmo2*(sw04+(0.1D1-sw04)*sp
     ...
     +so4))-por(j)/(-1+por(j))*kmnox*sp(10,j)-2*por(j)/(-1+por(j))/delt
         pd(11,26) = 0
     ...
     +elt
         ...
         pd(16,46) = 0
         pd(21,11) = 0
         pd(36,37) = sw23*kmgcdis*(0.1D1-sp(22,j)*sp(17,j)/kspmgc)+1/del
     +t
         pd(42,5) = 0
         pd(45,35) = 0
         pd(51,29) = 0
     ...
     +21*karadis*sp(36,j)*sp(22,j)/kspara
         ...
         pd(6,13) = (-1+por(j))/por(j)*kh2smno2*sp(4,j)/8+(-1+por(j))/po
     +r(j)*kh2sfeoh3*sp(5,j)/8+(-1+por(j))/por(j)*kh2smno2pr*sp(33,j)/8+
     +1/delt/4
         pd(11,37) = 0
         pd(17,5) = 0
         pd(21,50) = 0
     ...
     +20,j)**8/kspillite
         pd(54,33) = 0
         pd(4,55) = 0
         pd(6,5) = (-1+por(j))/por(j)*kfeage/16+(-1+por(j))/por(j)*kh2sf
     +eoh3*(sp(12,j)+sp(13,j))/8+(-1+por(j))/por(j)/delt/16
         pd(6,49) = 0
         pd(9,20) = 0
         pd(11,15) = 0
         pd(16,6) = 0
     ...
     +,j)**6/kspsmect+0.14812422D9/0.207357157D9*por(j)/(-1+por(j))/delt
         ...
         pd(4,6) = 2*nu/(inita+sp(32,j))*sp(1,j)*sw09*(0.1D1-sw02-(0.1D1
     +-sw02)*sp(2,j)/kmo2-sw03*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2)*(s
     ...
     +no2))*(sw08+(0.1D1-sw08)*sp(5,j)/kmfeoh3))*(0.1D1-sw10)/kmso4-2*nu
     +/(inita+sp(32,j))*sp(1,j)*sw11*sw09*(0.1D1-sw02-(0.1D1-sw02)*sp(2,
     +j)/kmo2-sw03*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2)*(sw04+(0.1D1-s
     +w04)*sp(3,j)/kmno3)-sw05*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2-sw0
     +3*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2)*(sw04+(0.1D1-sw04)*sp(3,j
     ...
     +(0.1D1-sw08)*sp(5,j)/kmfeoh3))*(0.1D1-sw10)/kmso4
         ...
         pd(52,55) = 0
         pd(55,18) = 0
         pd(4,1) = 2*nu/(inita+sp(32,j))*sw09*(0.1D1-sw02-(0.1D1-sw02)*s
     ...
     +w08+(0.1D1-sw08)*sp(5,j)/kmfeoh3))*(sw10+(0.1D1-sw10)*sp(6,j)/kmso
     +4)+2*nu/(inita+sp(32,j))*sw07*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo
     +2-sw03*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2)*(sw04+(0.1D1-sw04)*s
     +p(3,j)/kmno3)-sw05*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2-sw03*(0.1
     +D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2)*(sw04+(0.1D1-sw04)*sp(3,j)/kmno
     +3))*(sw06+(0.1D1-sw06)*sp(4,j)/kmmno2))*(sw08+(0.1D1-sw08)*sp(5,j)
     +/kmfeoh3)+2*nu/(inita+sp(32,j))*sw11*(0.1D1-sw02-(0.1D1-sw02)*sp(2
     +,j)/kmo2-sw03*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2)*(sw04+(0.1D1-
     +sw04)*sp(3,j)/kmno3)-sw05*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2-sw
     +03*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2)*(sw04+(0.1D1-sw04)*sp(3,
     ...
     ++(0.1D1-sw08)*sp(5,j)/kmfeoh3)-sw09*(0.1D1-sw02-(0.1D1-sw02)*sp(2,
     +j)/kmo2-sw03*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2)*(sw04+(0.1D1-s
     +w04)*sp(3,j)/kmno3)-sw05*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2-sw0
     +3*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2)*(sw04+(0.1D1-sw04)*sp(3,j
     +)/kmno3))*(sw06+(0.1D1-sw06)*sp(4,j)/kmmno2)-sw07*(0.1D1-sw02-(0.1
     ...
     +s))*(0.1D1-sp(40,j)/BSisat)-1/delt
         ...
         pd(23,41) = 0
         pd(32,45) = 0
         pd(36,22) = -sw23*kmgcdis*sp(37,j)*sp(17,j)/kspmgc+por(j)/(-1+p
     +or(j))*sw24*kmgcppt*sp(17,j)/kspmgc
         pd(45,20) = -1/delt
         pd(51,14) = 0
         pd(5,8) = 0
         pd(7,9) = 0
     ...
     +por(j))/delt
         ...
         pd(4,32) = -2*nu/(inita+sp(32,j))**2*sp(1,j)*sw09*(0.1D1-sw02-(
     ...
     +)*sp(2,j)/kmo2-sw03*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2)*(sw04+(
     +0.1D1-sw04)*sp(3,j)/kmno3))*(sw06+(0.1D1-sw06)*sp(4,j)/kmmno2))*(s
     +w08+(0.1D1-sw08)*sp(5,j)/kmfeoh3)-2*nu/(inita+sp(32,j))**2*sp(1,j)
     ...
     +/4889.D0/delt
         ...
         pd(23,36) = 0
         pd(32,40) = 0
         pd(36,17) = -sw23*kmgcdis*sp(37,j)*sp(22,j)/kspmgc+por(j)/(-1+p
     +or(j))*sw24*kmgcppt*sp(22,j)/kspmgc
         pd(39,27) = 0
     ...
     +p(1,j)*sw09*sw07*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2-sw03*(0.1D1
     +-sw02-(0.1D1-sw02)*sp(2,j)/kmo2)*(sw04+(0.1D1-sw04)*sp(3,j)/kmno3)
     +-sw05*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2-sw03*(0.1D1-sw02-(0.1D
     +1-sw02)*sp(2,j)/kmo2)*(sw04+(0.1D1-sw04)*sp(3,j)/kmno3))*(sw06+(0.
     +1D1-sw06)*sp(4,j)/kmmno2))*(0.1D1-sw08)/kmfeoh3*(sw10+(0.1D1-sw10)
     +*sp(6,j)/kmso4)+2*nu/(inita+sp(32,j))*sp(1,j)*sw07*(0.1D1-sw02-(0.
     +1D1-sw02)*sp(2,j)/kmo2-sw03*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2)
     +*(sw04+(0.1D1-sw04)*sp(3,j)/kmno3)-sw05*(0.1D1-sw02-(0.1D1-sw02)*s
     +p(2,j)/kmo2-sw03*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2)*(sw04+(0.1
     +D1-sw04)*sp(3,j)/kmno3))*(sw06+(0.1D1-sw06)*sp(4,j)/kmmno2))*(0.1D
     +1-sw08)/kmfeoh3+2*nu/(inita+sp(32,j))*sp(1,j)*sw11*(-sw07*(0.1D1-s
     +w02-(0.1D1-sw02)*sp(2,j)/kmo2-sw03*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j
     +)/kmo2)*(sw04+(0.1D1-sw04)*sp(3,j)/kmno3)-sw05*(0.1D1-sw02-(0.1D1-
     +sw02)*sp(2,j)/kmo2-sw03*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2)*(sw
     +04+(0.1D1-sw04)*sp(3,j)/kmno3))*(sw06+(0.1D1-sw06)*sp(4,j)/kmmno2)
     +)*(0.1D1-sw08)/kmfeoh3+sw09*sw07*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/
     +kmo2-sw03*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2)*(sw04+(0.1D1-sw04
     +)*sp(3,j)/kmno3)-sw05*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2-sw03*(
     +0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2)*(sw04+(0.1D1-sw04)*sp(3,j)/k
     +mno3))*(sw06+(0.1D1-sw06)*sp(4,j)/kmmno2))*(0.1D1-sw08)/kmfeoh3*(s
     +w10+(0.1D1-sw10)*sp(6,j)/kmso4))+kfeage/2+1/delt/2
         pd(5,14) = 0
         pd(7,15) = 0
         pd(12,4) = 0
         pd(12,44) = 0
     ...
     +so4)
         ...
         pd(43,48) = 0
         pd(52,12) = 0
         pd(4,3) = 2*nu/(inita+sp(32,j))*sp(1,j)*sw09*(-sw03*(0.1D1-sw02
     ...
     +(0.1D1-sw08)*sp(5,j)/kmfeoh3))*(sw10+(0.1D1-sw10)*sp(6,j)/kmso4)+2
     +*nu/(inita+sp(32,j))*sp(1,j)*sw07*(-sw03*(0.1D1-sw02-(0.1D1-sw02)*
     +sp(2,j)/kmo2)*(0.1D1-sw04)/kmno3+sw05*sw03*(0.1D1-sw02-(0.1D1-sw02
     +)*sp(2,j)/kmo2)*(0.1D1-sw04)/kmno3*(sw06+(0.1D1-sw06)*sp(4,j)/kmmn
     +o2))*(sw08+(0.1D1-sw08)*sp(5,j)/kmfeoh3)+2*nu/(inita+sp(32,j))*sp(
     +1,j)*sw11*(-sw03*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2)*(0.1D1-sw0
     +4)/kmno3+sw05*sw03*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2)*(0.1D1-s
     +w04)/kmno3*(sw06+(0.1D1-sw06)*sp(4,j)/kmmno2)-sw07*(-sw03*(0.1D1-s
     +w02-(0.1D1-sw02)*sp(2,j)/kmo2)*(0.1D1-sw04)/kmno3+sw05*sw03*(0.1D1
     +-sw02-(0.1D1-sw02)*sp(2,j)/kmo2)*(0.1D1-sw04)/kmno3*(sw06+(0.1D1-s
     +w06)*sp(4,j)/kmmno2))*(sw08+(0.1D1-sw08)*sp(5,j)/kmfeoh3)-sw09*(-s
     +w03*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2)*(0.1D1-sw04)/kmno3+sw05
     +*sw03*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2)*(0.1D1-sw04)/kmno3*(s
     +w06+(0.1D1-sw06)*sp(4,j)/kmmno2)-sw07*(-sw03*(0.1D1-sw02-(0.1D1-sw
     +02)*sp(2,j)/kmo2)*(0.1D1-sw04)/kmno3+sw05*sw03*(0.1D1-sw02-(0.1D1-
     +sw02)*sp(2,j)/kmo2)*(0.1D1-sw04)/kmno3*(sw06+(0.1D1-sw06)*sp(4,j)/
     +kmmno2))*(sw08+(0.1D1-sw08)*sp(5,j)/kmfeoh3))*(sw10+(0.1D1-sw10)*s
     +p(6,j)/kmso4))+809.D0/78.D0*por(j)/(-1+por(j))/delt
     ...
     +)*sp(5,j)/kmfeoh3))*(0.1D1-sw10)/kmso4+6/delt
         ...
         pd(38,31) = 0
         pd(55,25) = 0
         pd(4,4) = 2*nu/(inita+sp(32,j))*sp(1,j)*sw09*(-sw05*(0.1D1-sw02
     ...
     +)/kmmno2*(sw08+(0.1D1-sw08)*sp(5,j)/kmfeoh3))*(sw10+(0.1D1-sw10)*s
     +p(6,j)/kmso4)-2*nu/(inita+sp(32,j))*sp(1,j)*sw07*sw05*(0.1D1-sw02-
     +(0.1D1-sw02)*sp(2,j)/kmo2-sw03*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/km
     +o2)*(sw04+(0.1D1-sw04)*sp(3,j)/kmno3))*(0.1D1-sw06)/kmmno2*(sw08+(
     +0.1D1-sw08)*sp(5,j)/kmfeoh3)+2*nu/(inita+sp(32,j))*sp(1,j)*sw11*(-
     +sw05*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2-sw03*(0.1D1-sw02-(0.1D1
     +-sw02)*sp(2,j)/kmo2)*(sw04+(0.1D1-sw04)*sp(3,j)/kmno3))*(0.1D1-sw0
     +6)/kmmno2+sw07*sw05*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2-sw03*(0.
     +1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2)*(sw04+(0.1D1-sw04)*sp(3,j)/kmn
     +o3))*(0.1D1-sw06)/kmmno2*(sw08+(0.1D1-sw08)*sp(5,j)/kmfeoh3)-sw09*
     +(-sw05*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2-sw03*(0.1D1-sw02-(0.1
     +D1-sw02)*sp(2,j)/kmo2)*(sw04+(0.1D1-sw04)*sp(3,j)/kmno3))*(0.1D1-s
     +w06)/kmmno2+sw07*sw05*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2-sw03*(
     +0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2)*(sw04+(0.1D1-sw04)*sp(3,j)/k
     +mno3))*(0.1D1-sw06)/kmmno2*(sw08+(0.1D1-sw08)*sp(5,j)/kmfeoh3))*(s
     +w10+(0.1D1-sw10)*sp(6,j)/kmso4))-kfemno2*sp(11,j)-kmnage-1/delt
     ...
     +0.1D1-sw10)*sp(6,j)/kmso4)
         ...
         pd(6,12) = (-1+por(j))/por(j)*kh2smno2*sp(4,j)/8+(-1+por(j))/po
     +r(j)*kh2sfeoh3*sp(5,j)/8+(-1+por(j))/por(j)*kh2smno2pr*sp(33,j)/8
         pd(16,13) = 0
         pd(17,4) = 0
         pd(22,9) = 0
