...
! Watch out the resolution doent coincide with the node
!		if (x(j-2).lt.0.299d0) then   		
!		  x(j) = x(j-2) + 0.01d0
!		else if (x(j-2).lt.0.99d0) then
!		  x(j) = x(j-2) + 0.02d0 
!		else if (x(j-2).lt.2.99d0) then
!	      x(j) = x(j-2) + 0.05d0
!	    else if (x(j-2).lt.4.99d0) then
!	      x(j) = x(j-2) + 0.1d0
!	    else if (x(j-2).lt.9.99d0) then
!	      x(j) = x(j-2) + 0.2d0
!	    else if (x(j-2).lt.99.99d0) then
!	      x(j) = x(j-2) + 0.5d0
!	    else if (x(j-2).lt.199.99d0) then
!	      x(j) = x(j-2) + 1.0d0
!	    else if (x(j-2).lt.514.99d0) then
!	      x(j) = x(j-2) + 3.0d0
!		end if

!           if (x(j-2).lt.0.79d0) then
!                x(j)=x(j-2)+0.05d0
! 	   if (x(j-2).lt.1.99d0) then
!                x(j)=x(j-2)+0.1d0
!	   else if (x(j-2).lt.14.99d0) then
!                x(j)=x(j-2)+0.2d0
!           else if (x(j-2).lt.19.99d0) then
!                x(j)=x(j-2)+0.5d0
!           else if (x(j-2).lt.29.99d0) then
!                x(j)=x(j-2)+1.0d0
!           else
!                x(j)=x(j-2)+2.0d0
!           end if
