...
c      
     ...
     +/KsMnCO3-0.1D1)*(0.1D1-por(j))/por(j)
            drdc = -kmnox*sp(2,j)-kmnco3precip*sw12*sp(17,j)/KsMnCO3*(0.
     +1D1-por(j))/por(j)
            endif
            if (isp.eq.11) then
     ...
     +sp(2,j)-kfesprecip*sw13*(sp(11,j)*sp(13,j)/sp(20,j)/KsFeS-0.1D1)-(
     +0.1D1-por(j))/por(j)*kfeco3precip*sw14*(sp(11,j)*sp(17,j)/KsFeCO3-
     +0.1D1)+(0.1D1-por(j))/por(j)*kfesdiss*(0.1D1-sw13)*sp(25,j)*(0.1D1
     +-sp(11,j)*sp(13,j)/sp(20,j)/KsFeS)-(kf8*sp(11,j)*por(j)-kb8*sp(29,
     +j)*(1.D0-por(j)))/por(j)-0.2D1*(kfemno2*sp(11,j)*sp(4,j)+kfemno2pr
     +*sp(11,j)*sp(33,j))*(0.1D1-por(j))/por(j)+0.46D0*(0.1D1-por(j))/po
     +r(j)*r67+0.4D0*(0.1D1-por(j))/por(j)*r66
            drdc = -kfeo2*sp(2,j)-kfesprecip*sw13*sp(13,j)/sp(20,j)/KsFe
     +S-(0.1D1-por(j))/por(j)*kfeco3precip*sw14*sp(17,j)/KsFeCO3-(0.1D1-
     +por(j))/por(j)*kfesdiss*(0.1D1-sw13)*sp(25,j)*sp(13,j)/sp(20,j)/Ks
     +FeS-kf8-0.2D1*(kfemno2*sp(4,j)+kfemno2pr*sp(33,j))*(0.1D1-por(j))/
     +por(j)
            endif
            if (isp.eq.12) then
            rat = 0.5D0*(0.1D1-por(j))/por(j)*nu/(inita+sp(32,j))*sp(1,j
     ...
     +kgas*(sp(7,j)-ch4eq)
            ...
            if (isp.eq.15) then
            rat = 0.1132075472D1*(0.1D1-por(j))/por(j)*nu/(inita+sp(32,j
     +))*sp(1,j)*(sw02+(0.1D1-sw02)*sp(2,j)/kmo2)+0.1509433962D0*(0.1D1-
     +por(j))/por(j)*nu/(inita+sp(32,j))*sp(1,j)*sw03*(0.1D1-sw02-(0.1D1
     +-sw02)*sp(2,j)/kmo2)*(sw04+(0.1D1-sw04)*sp(3,j)/kmno3)-0.309433962
     +3D1*(0.1D1-por(j))/por(j)*nu/(inita+sp(32,j))*sp(1,j)*sw05*(0.1D1-
     +sw02-(0.1D1-sw02)*sp(2,j)/kmo2-sw03*(0.1D1-sw02-(0.1D1-sw02)*sp(2,
     +j)/kmo2)*(sw04+(0.1D1-sw04)*sp(3,j)/kmno3))*(sw06+(0.1D1-sw06)*sp(
     +4,j)/kmmno2)-0.9433962264D-1*(0.1D1-por(j))/por(j)*nu/(inita+sp(32
     +,j))*sp(1,j)*sw09*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2-sw03*(0.1D
     +1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2)*(sw04+(0.1D1-sw04)*sp(3,j)/kmno3
     +)-sw05*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2-sw03*(0.1D1-sw02-(0.1
     +D1-sw02)*sp(2,j)/kmo2)*(sw04+(0.1D1-sw04)*sp(3,j)/kmno3))*(sw06+(0
     ...
     +j)/kmfeoh3))*(sw10+(0.1D1-sw10)*sp(6,j)/kmso4)+0.4056603774D0*(0.1
     +D1-por(j))/por(j)*nu/(inita+sp(32,j))*sp(1,j)*sw11*(0.1D1-sw02-(0.
     +1D1-sw02)*sp(2,j)/kmo2-sw03*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2)
     +*(sw04+(0.1D1-sw04)*sp(3,j)/kmno3)-sw05*(0.1D1-sw02-(0.1D1-sw02)*s
     +p(2,j)/kmo2-sw03*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2)*(sw04+(0.1
     +D1-sw04)*sp(3,j)/kmno3))*(sw06+(0.1D1-sw06)*sp(4,j)/kmmno2)-sw07*(
     ...
     +o2)*(sw04+(0.1D1-sw04)*sp(3,j)/kmno3))*(sw06+(0.1D1-sw06)*sp(4,j)/
     +kmmno2))*(sw08+(0.1D1-sw08)*sp(5,j)/kmfeoh3)-sw09*(0.1D1-sw02-(0.1
     +D1-sw02)*sp(2,j)/kmo2-sw03*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2)*
     +(sw04+(0.1D1-sw04)*sp(3,j)/kmno3)-sw05*(0.1D1-sw02-(0.1D1-sw02)*sp
     ...
     +mmno2))*(sw08+(0.1D1-sw08)*sp(5,j)/kmfeoh3))*(sw10+(0.1D1-sw10)*sp
     +(6,j)/kmso4))-0.7094339623D1*(0.1D1-por(j))/por(j)*nu/(inita+sp(32
     +,j))*sp(1,j)*sw07*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2-sw03*(0.1D
     +1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2)*(sw04+(0.1D1-sw04)*sp(3,j)/kmno3
     +)-sw05*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2-sw03*(0.1D1-sw02-(0.1
     +D1-sw02)*sp(2,j)/kmo2)*(sw04+(0.1D1-sw04)*sp(3,j)/kmno3))*(sw06+(0
     +.1D1-sw06)*sp(4,j)/kmmno2))*(sw08+(0.1D1-sw08)*sp(5,j)/kmfeoh3)+0.
     +2D1*knit*sp(8,j)*sp(2,j)-kaom*sp(7,j)*sp(6,j)+kaomo2*sp(7,j)*sp(2,
     +j)+0.2D1*kh2so2*(sp(12,j)+sp(13,j))*sp(2,j)-0.4D1*(0.1D1-por(j))/p
     +or(j)*(kh2sfeoh3*sp(5,j)*(sp(12,j)+sp(13,j))+kh2sfeoh3mr*sp(34,j)*
     +(sp(12,j)+sp(13,j))+kh2sfeoh3pr*sp(35,j)*(sp(12,j)+sp(13,j)))+kf1*
     +sp(20,j)*sp(16,j)-kb1*sp(15,j)+0.2D1*kfeo2*sp(11,j)*sp(2,j)+0.2D1*
     +kfesprecip*sw13*(sp(11,j)*sp(13,j)/sp(20,j)/KsFeS-0.1D1)+0.2D1*kdi
     +*sw19*sp(27,j)-0.2D1*(0.1D1-por(j))/por(j)*kfesdiss*(0.1D1-sw13)*s
     +p(25,j)*(0.1D1-sp(11,j)*sp(13,j)/sp(20,j)/KsFeS)+0.2D1*kmnox*sp(10
     +,j)*sp(2,j)+0.2D1*(kfemno2*sp(11,j)*sp(4,j)+kfemno2pr*sp(11,j)*sp(
     +33,j))*(0.1D1-por(j))/por(j)-0.2D1*(kh2smno2*sp(4,j)*(sp(12,j)+sp(
     +13,j))+kh2smno2pr*sp(33,j)*(sp(12,j)+sp(13,j)))*(0.1D1-por(j))/por
     +(j)
            drdc = -kb1
            endif
            if (isp.eq.16) then
            rat = -0.1320754717D0*(0.1D1-por(j))/por(j)*nu/(inita+sp(32,
     +j))*sp(1,j)*(sw02+(0.1D1-sw02)*sp(2,j)/kmo2)+0.8490566038D0*(0.1D1
     +-por(j))/por(j)*nu/(inita+sp(32,j))*sp(1,j)*sw03*(0.1D1-sw02-(0.1D
     +1-sw02)*sp(2,j)/kmo2)*(sw04+(0.1D1-sw04)*sp(3,j)/kmno3)+0.40943396
     +23D1*(0.1D1-por(j))/por(j)*nu/(inita+sp(32,j))*sp(1,j)*sw05*(0.1D1
     +-sw02-(0.1D1-sw02)*sp(2,j)/kmo2-sw03*(0.1D1-sw02-(0.1D1-sw02)*sp(2
     +,j)/kmo2)*(sw04+(0.1D1-sw04)*sp(3,j)/kmno3))*(sw06+(0.1D1-sw06)*sp
     +(4,j)/kmmno2)+0.1094339623D1*(0.1D1-por(j))/por(j)*nu/(inita+sp(32
     +,j))*sp(1,j)*sw09*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2-sw03*(0.1D
     +1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2)*(sw04+(0.1D1-sw04)*sp(3,j)/kmno3
     +)-sw05*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2-sw03*(0.1D1-sw02-(0.1
     +D1-sw02)*sp(2,j)/kmo2)*(sw04+(0.1D1-sw04)*sp(3,j)/kmno3))*(sw06+(0
     ...
     +.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2)*(sw04+(0.1D1-sw04)*sp(3,j)/km
     +no3))*(sw06+(0.1D1-sw06)*sp(4,j)/kmmno2))*(sw08+(0.1D1-sw08)*sp(5,
     +j)/kmfeoh3))*(sw10+(0.1D1-sw10)*sp(6,j)/kmso4)+0.9433962264D-1*(0.
     +1D1-por(j))/por(j)*nu/(inita+sp(32,j))*sp(1,j)*sw11*(0.1D1-sw02-(0
     +.1D1-sw02)*sp(2,j)/kmo2-sw03*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2
     ...
     +p(6,j)/kmso4))+0.8094339623D1*(0.1D1-por(j))/por(j)*nu/(inita+sp(3
     +2,j))*sp(1,j)*sw07*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2-sw03*(0.1
     +D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2)*(sw04+(0.1D1-sw04)*sp(3,j)/kmno
     +3)-sw05*(0.1D1-sw02-(0.1D1-sw02)*sp(2,j)/kmo2-sw03*(0.1D1-sw02-(0.
     +1D1-sw02)*sp(2,j)/kmo2)*(sw04+(0.1D1-sw04)*sp(3,j)/kmno3))*(sw06+(
     +0.1D1-sw06)*sp(4,j)/kmmno2))*(sw08+(0.1D1-sw08)*sp(5,j)/kmfeoh3)-0
     +.2D1*knit*sp(8,j)*sp(2,j)+0.2D1*kaom*sp(7,j)*sp(6,j)-0.2D1*kh2so2*
     +(sp(12,j)+sp(13,j))*sp(2,j)+0.4D1*(0.1D1-por(j))/por(j)*(kh2sfeoh3
     +*sp(5,j)*(sp(12,j)+sp(13,j))+kh2sfeoh3mr*sp(34,j)*(sp(12,j)+sp(13,
     +j))+kh2sfeoh3pr*sp(35,j)*(sp(12,j)+sp(13,j)))-kf1*sp(20,j)*sp(16,j
     +)+kb1*sp(15,j)+kf2*sp(20,j)*sp(17,j)-kb2*sp(16,j)-0.2D1*kfeo2*sp(1
     +1,j)*sp(2,j)-0.2D1*kfesprecip*sw13*(sp(11,j)*sp(13,j)/sp(20,j)/KsF
     +eS-0.1D1)-0.2D1*kdi*sw19*sp(27,j)+0.2D1*(0.1D1-por(j))/por(j)*kfes
     +diss*(0.1D1-sw13)*sp(25,j)*(0.1D1-sp(11,j)*sp(13,j)/sp(20,j)/KsFeS
     +)-0.2D1*kmnox*sp(10,j)*sp(2,j)-0.2D1*(kfemno2*sp(11,j)*sp(4,j)+kfe
     +mno2pr*sp(11,j)*sp(33,j))*(0.1D1-por(j))/por(j)+0.2D1*(kh2smno2*sp
     +(4,j)*(sp(12,j)+sp(13,j))+kh2smno2pr*sp(33,j)*(sp(12,j)+sp(13,j)))
     +*(0.1D1-por(j))/por(j)
     ...
     +p(22,j)*sp(17,j)/kspara-0.5D1)+(0.1D1-por(j))/por(j)*sw23*kmgcdis*
     +sp(37,j)*(0.1D1-sp(22,j)*sp(17,j)/kspmgc)-sw24*kmgcppt*(sp(22,j)*s
     +p(17,j)/kspmgc-0.1D1)-kmnco3precip*sw12*(sp(10,j)*sp(17,j)/KsMnCO3
     +-0.1D1)-kfeco3precip*sw14*(sp(11,j)*sp(17,j)/KsFeCO3-0.1D1)
     ...
     +/kspara-(0.1D1-por(j))/por(j)*sw23*kmgcdis*sp(37,j)*sp(22,j)/kspmg
     +c-sw24*kmgcppt*sp(22,j)/kspmgc-kmnco3precip*sw12*sp(10,j)/KsMnCO3-
     +kfeco3precip*sw14*sp(11,j)/KsFeCO3
            endif
            if (isp.eq.18) then
     ...
     +p(18,j)+kb4*sp(19,j)-kf10*sp(43,j)*sp(20,j)+kb10*sp(42,j)-0.2D1*kf
     +11*sp(44,j)*sp(20,j)**2+0.2D1*kb11*sp(42,j)-0.3D1*kf12*sp(45,j)*sp
     +(20,j)**3+0.3D1*kb12*sp(42,j)-0.4D1*kf13*sp(46,j)*sp(20,j)**4+0.4D
     +1*kb13*sp(42,j)-0.108D1*(0.1D1-por(j))/por(j)*sw26*kglass*sp(47,j)
     +*(sp(20,j)**3/sp(42,j))**(1.D0/3.D0)*(0.1D1-sp(40,j)*sp(42,j)**0.3
     +6D0/sp(20,j)**0.108D1/kspglass)+0.8D1*sw30*killite*(sp(40,j)**0.35
     +D1*sp(42,j)**0.23D1*sp(50,j)**0.6D0*sp(38,j)**0.25D0/sp(20,j)**8/k
     +spillite-0.1D1)-0.4D1*(0.1D1-por(j))/por(j)*sw29*kpyrox*sp(52,j)*(
     +0.1D1-sp(40,j)**2*sp(11,j)**0.46D0*sp(38,j)**0.84D0*sp(22,j)**0.7D
     +0/sp(20,j)**4/ksppyrox)-0.4D1*(0.1D1-por(j))/por(j)*sw28*kolive*sp
     +(51,j)*(0.1D1-sp(40,j)*sp(38,j)**0.16D1*sp(11,j)**0.4D0/sp(20,j)**
     +4/kspolive)+0.6D1*sw31*ksmect*(sp(22,j)**0.165D0*sp(38,j)**0.33D0*
     +sp(42,j)**0.17D1*sp(40,j)**4/sp(20,j)**6/kspsmect-0.1D1)+0.6D1*sw3
     +2*kkaoli*(sp(42,j)**2*sp(40,j)**2/sp(20,j)**6/kspkaoli-0.1D1)
            drdc = -kf1*sp(16,j)-kf2*sp(17,j)-kf3*sp(13,j)-kf4*sp(18,j)-
     +kf10*sp(43,j)-0.4D1*kf11*sp(44,j)*sp(20,j)-0.9D1*kf12*sp(45,j)*sp(
     +20,j)**2-0.16D2*kf13*sp(46,j)*sp(20,j)**3-0.108D1*(0.1D1-por(j))/p
     +or(j)*sw26*kglass*sp(47,j)/(sp(20,j)**3/sp(42,j))**(2.D0/3.D0)*(0.
     +1D1-sp(40,j)*sp(42,j)**0.36D0/sp(20,j)**0.108D1/kspglass)*sp(20,j)
     +**2/sp(42,j)-0.11664D1*(0.1D1-por(j))/por(j)*sw26*kglass*sp(47,j)*
     +(sp(20,j)**3/sp(42,j))**(1.D0/3.D0)*sp(40,j)*sp(42,j)**0.36D0/sp(2
     +0,j)**0.208D1/kspglass-0.64D2*sw30*killite*sp(40,j)**0.35D1*sp(42,
     +j)**0.23D1*sp(50,j)**0.6D0*sp(38,j)**0.25D0/sp(20,j)**9/kspillite-
     +0.16D2*(0.1D1-por(j))/por(j)*sw29*kpyrox*sp(52,j)*sp(40,j)**2*sp(1
     +1,j)**0.46D0*sp(38,j)**0.84D0*sp(22,j)**0.7D0/sp(20,j)**5/ksppyrox
     +-0.16D2*(0.1D1-por(j))/por(j)*sw28*kolive*sp(51,j)*sp(40,j)*sp(38,
     +j)**0.16D1*sp(11,j)**0.4D0/sp(20,j)**5/kspolive-0.36D2*sw31*ksmect
     +*sp(22,j)**0.165D0*sp(38,j)**0.33D0*sp(42,j)**0.17D1*sp(40,j)**4/s
     +p(20,j)**7/kspsmect-0.36D2*sw32*kkaoli*sp(42,j)**2*sp(40,j)**2/sp(
     +20,j)**7/kspkaoli
            endif
            if (isp.eq.21) then
     ...
     +1-por(j))/por(j)*sw23*kmgcdis*sp(37,j)*(0.1D1-sp(22,j)*sp(17,j)/ks
     +pmgc)-sw24*kmgcppt*(sp(22,j)*sp(17,j)/kspmgc-0.1D1)+0.7D0*(0.1D1-p
     +or(j))/por(j)*sw29*kpyrox*sp(52,j)*(0.1D1-sp(40,j)**2*sp(11,j)**0.
     +46D0*sp(38,j)**0.84D0*sp(22,j)**0.7D0/sp(20,j)**4/ksppyrox)+0.7D0*
     +(0.1D1-por(j))/por(j)*sw27*kplagio*sp(48,j)*(sp(20,j)**3/sp(42,j))
     +**0.35D0*(0.1D1-sp(40,j)**0.23D1*sp(46,j)**0.17D1*sp(49,j)**0.3D0*
     +sp(22,j)**0.7D0/kspplagio)-0.165D0*sw31*ksmect*(sp(22,j)**0.165D0*
     +sp(38,j)**0.33D0*sp(42,j)**0.17D1*sp(40,j)**4/sp(20,j)**6/kspsmect
     +-0.1D1)
            drdc = -(0.1D1-por(j))/por(j)*sw15*kcaldiss*sp(21,j)*sp(17,j
     +)/kspcal-sw20*kcalppt*sp(17,j)/kspcal-(0.1D1-por(j))/por(j)*sw21*k
     +aradis*sp(36,j)*sp(17,j)/kspara-sw22*karappt*sp(17,j)/kspara-(0.1D
     +1-por(j))/por(j)*sw23*kmgcdis*sp(37,j)*sp(17,j)/kspmgc-sw24*kmgcpp
     +t*sp(17,j)/kspmgc-0.49D0*(0.1D1-por(j))/por(j)*sw29*kpyrox*sp(52,j
     +)*sp(40,j)**2*sp(11,j)**0.46D0*sp(38,j)**0.84D0/sp(22,j)**0.3D0/sp
     +(20,j)**4/ksppyrox-0.49D0*(0.1D1-por(j))/por(j)*sw27*kplagio*sp(48
     +,j)*(sp(20,j)**3/sp(42,j))**0.35D0*sp(40,j)**0.23D1*sp(46,j)**0.17
     +D1*sp(49,j)**0.3D0/sp(22,j)**0.3D0/kspplagio-0.27225D-1*sw31*ksmec
     +t/sp(22,j)**0.835D0*sp(38,j)**0.33D0*sp(42,j)**0.17D1*sp(40,j)**4/
     +sp(20,j)**6/kspsmect
            endif
            if (isp.eq.23) then
     ...
     +(j)
            ...
            if (isp.eq.37) then
            rat = -sw23*kmgcdis*sp(37,j)*(0.1D1-sp(22,j)*sp(17,j)/kspmgc
     +)+sw24*kmgcppt*(sp(22,j)*sp(17,j)/kspmgc-0.1D1)/(0.1D1-por(j))*por
     +(j)
            drdc = -sw23*kmgcdis*(0.1D1-sp(22,j)*sp(17,j)/kspmgc)
            endif
            if (isp.eq.38) then
     ...
     +p(40,j)**0.23D1*sp(46,j)**0.17D1*sp(49,j)**0.3D0*sp(22,j)**0.7D0/k
     ...
     +D1*sp(46,j)**0.17D1*sp(49,j)**0.3D0*sp(22,j)**0.7D0/kspplagio-0.12
     ...
     +20,j)**2-kb11*sp(42,j)+kf12*sp(45,j)*sp(20,j)**3-kb12*sp(42,j)+kf1
     +3*sp(46,j)*sp(20,j)**4-kb13*sp(42,j)+0.36D0*(0.1D1-por(j))/por(j)*
     +sw26*kglass*sp(47,j)*(sp(20,j)**3/sp(42,j))**(1.D0/3.D0)*(0.1D1-sp
     +(40,j)*sp(42,j)**0.36D0/sp(20,j)**0.108D1/kspglass)-0.23D1*sw30*ki
     +llite*(sp(40,j)**0.35D1*sp(42,j)**0.23D1*sp(50,j)**0.6D0*sp(38,j)*
     +*0.25D0/sp(20,j)**8/kspillite-0.1D1)+0.25D-2*sw25*(kBSidis*bd+(kBS
     +idis-kBSidis*bd)*exp(-ad*x_pos))*sp(39,j)*(0.1D1-sp(40,j)/BSisat)*
     +(0.1D1-por(j))/por(j)-0.17D1*sw31*ksmect*(sp(22,j)**0.165D0*sp(38,
     +j)**0.33D0*sp(42,j)**0.17D1*sp(40,j)**4/sp(20,j)**6/kspsmect-0.1D1
     +)-0.2D1*sw32*kkaoli*(sp(42,j)**2*sp(40,j)**2/sp(20,j)**6/kspkaoli-
     +0.1D1)
            drdc = -kb10-kb11-kb12-kb13-0.12D0*(0.1D1-por(j))/por(j)*sw2
     +6*kglass*sp(47,j)/(sp(20,j)**3/sp(42,j))**(2.D0/3.D0)*(0.1D1-sp(40
     +,j)*sp(42,j)**0.36D0/sp(20,j)**0.108D1/kspglass)*sp(20,j)**3/sp(42
     +,j)**2-0.1296D0*(0.1D1-por(j))/por(j)*sw26*kglass*sp(47,j)*(sp(20,
     +j)**3/sp(42,j))**(1.D0/3.D0)*sp(40,j)/sp(42,j)**0.64D0/sp(20,j)**0
     +.108D1/kspglass-0.529D1*sw30*killite*sp(40,j)**0.35D1*sp(42,j)**0.
     +13D1*sp(50,j)**0.6D0*sp(38,j)**0.25D0/sp(20,j)**8/kspillite-0.289D
     +1*sw31*ksmect*sp(22,j)**0.165D0*sp(38,j)**0.33D0*sp(42,j)**0.7D0*s
     +p(40,j)**4/sp(20,j)**6/kspsmect-0.4D1*sw32*kkaoli*sp(42,j)*sp(40,j
     +)**2/sp(20,j)**6/kspkaoli
            endif
            if (isp.eq.43) then
            rat = -kf10*sp(43,j)*sp(20,j)+kb10*sp(42,j)
            drdc = -kf10*sp(20,j)
            endif
            if (isp.eq.44) then
            rat = -kf11*sp(44,j)*sp(20,j)**2+kb11*sp(42,j)
            drdc = -kf11*sp(20,j)**2
            endif
            if (isp.eq.45) then
            rat = -kf12*sp(45,j)*sp(20,j)**3+kb12*sp(42,j)
            drdc = -kf12*sp(20,j)**3
            endif
            if (isp.eq.46) then
            rat = -kf13*sp(46,j)*sp(20,j)**4+kb13*sp(42,j)+0.17D1*(0.1D1
     +-por(j))/por(j)*sw27*kplagio*sp(48,j)*(sp(20,j)**3/sp(42,j))**0.35
     +D0*(0.1D1-sp(40,j)**0.23D1*sp(46,j)**0.17D1*sp(49,j)**0.3D0*sp(22,
     +j)**0.7D0/kspplagio)
            drdc = -kf13*sp(20,j)**4-0.289D1*(0.1D1-por(j))/por(j)*sw27*
     +kplagio*sp(48,j)*(sp(20,j)**3/sp(42,j))**0.35D0*sp(40,j)**0.23D1*s
     +p(46,j)**0.7D0*sp(49,j)**0.3D0*sp(22,j)**0.7D0/kspplagio
            endif
            if (isp.eq.47) then
     ...
     +(0.1D1-sp(40,j)**0.23D1*sp(46,j)**0.17D1*sp(49,j)**0.3D0*sp(22,j)*
     +*0.7D0/kspplagio)
     ...
     +spplagio)
            ...
            if (isp.eq.49) then
            rat = 0.3D0*(0.1D1-por(j))/por(j)*sw27*kplagio*sp(48,j)*(sp(
     +20,j)**3/sp(42,j))**0.35D0*(0.1D1-sp(40,j)**0.23D1*sp(46,j)**0.17D
     +1*sp(49,j)**0.3D0*sp(22,j)**0.7D0/kspplagio)
            drdc = -0.9D-1*(0.1D1-por(j))/por(j)*sw27*kplagio*sp(48,j)*(
     +sp(20,j)**3/sp(42,j))**0.35D0*sp(40,j)**0.23D1*sp(46,j)**0.17D1/sp
     +(49,j)**0.7D0*sp(22,j)**0.7D0/kspplagio
            endif
            if (isp.eq.50) then
